    ...
    <div class="d-flex justify-content-center align-items-center vh-100">
        <div class="card shadow" style="width: 24rem;">
            <div class="card-body text-center">
                ...
                <form action="bmi/hitung_bmi.php" method="post">
                    <div class="row text-start p-3">
                        <label class="form-label" for="tinggi">Tinggi Badan</label>
                        <input class="form-control" name="tinggi" type="text">
                        <label class="form-label" for="berat">Berat Badan</label>
                        <input class="form-control" name="berat" type="text">
                        <button class="btn btn-success mt-4" inputmode="submit">Hitung</button>
                    </div>
                </form>
            </div>
        </div>
