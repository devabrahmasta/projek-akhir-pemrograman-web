...
<body class="bg-dark">
    <nav class="navbar navbar-expand-lg bg-transparent mx-5 px-5 sticky-top mb-5">
        <div class="container-fluid py-3">
            <img style="width: 60px; height: 60px; object-fit: cover;"
                ...
                alt="anjer">
            <a class="navbar-brand text-white fw-bold" href="../main_page/index.php">Power GYM</a>
    ...
    <div class="d-flex justify-content-center align-items-center vh-80 w-100">
        <div class="row bmi-row">

            <div class="col-md-6 bmi-col">
                <div class="testimonial-card text-center bmi-card">
                    <h5 class="text-light mb-4">Hitung BMI</h5>
                    <form action="bmi.php" method="post" class="w-100">
                        <div class="text-start p-3">
                            ...
                            <label class="form-label mt-3 text-white" for="berat">Berat Badan (kg)</label>
                            <input class="form-control" name="berat" type="number" step="0.1" required
                                value="<?php echo htmlspecialchars($berat_val); ?>">

                            <button class="btn btn-success mt-4 w-100" type="submit">Hitung</button>
                        </div>
                    </form>

                    <?php if ($hasil !== null): ?>
                        <div class="alert <?php echo ($hasil == 'Error') ? 'alert-danger' : 'alert-success'; ?> mt-3 mx-3">
            ...
            <div class="col-md-6 bmi-col">
                <div class="testimonial-card bmi-card">
