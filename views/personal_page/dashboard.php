    ...
    <nav class="navbar navbar-expand-lg navbar-dark sticky-top px-5 py-3">
        <div class="container-fluid">
            <img style="width: 50px; height: 50px; object-fit: cover;"
                ...
                alt="Logo">
            <a class="navbar-brand text-warning fw-bold ms-2" href="index.php">Dashboard</a>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-12">
                                <div class="alert alert-dark-info d-flex align-items-center shadow-sm" role="alert">
                                    ...
                                    <div>
                                        Membership <strong><?php echo htmlspecialchars($member_data['deskripsi']); ?></strong> aktif, tapi belum punya Trainer.
                                        <a href="../membership/pilih_trainer.php?id_paket=<?php echo $member_data['id_paket'] ?? ''; ?>" class="alert-link fw-bold ms-1">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-12">
                            <div class="alert alert-dark-primary d-flex align-items-center shadow" role="alert">
                                ...
                                <div>
                                    <h5 class="alert-heading fw-bold mb-1">Selamat Datang, <?php echo htmlspecialchars($user_data['nama']); ?>! 👋</h5>
