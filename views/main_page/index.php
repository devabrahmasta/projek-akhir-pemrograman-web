                ...
                <ul class="nav nav-underline ">
                    ...
                    <li class="nav-item dropdown">
                        <?php if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] === true): ?>
                            <a class="nav-link dropdown-toggle text-warning fw-bold d-flex align-items-center" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <ion-icon name="person-circle-outline" style="font-size: 1.5rem; margin-right: 8px;"></ion-icon>
                                Akun Saya
                            </a>
