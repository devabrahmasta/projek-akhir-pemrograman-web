...
<body class="bg-dark">
    ...
    <div class="d-flex justify-content-center align-items-center" style="min-height: 90vh;">
        <div class="col-lg-5 col-md-8 col-sm-10 px-3">
            <div class="testimonial-card text-center" style="min-height: auto;">
                <h4 class="text-warning fw-bold mb-4">Daftar Akun Baru</h4>
                ...
                <form action="../../controllers/auth/register.php" method="post" class="text-start">
                    ...
                    <button class="btn btn-success w-100 fw-bold" type="submit">Daftar</button>
                </form>

                <p class="text-white mt-3 mb-0" style="font-size: 0.9rem;">
